...
//        获取当前账号所拥有的权限集合
    ...
    //删除课程浏览记录
    @DeleteMapping("/courseView/del/{courseViewId}")
    public Integer delCourseView(@PathVariable Integer courseViewId) {
        return userInfoService.delCourseViewById(courseViewId);
    }
    ...
    public List<CourseViewVO> getCourseView(@PathVariable Integer userId) {
